...
struct PickMenu_Previews: PreviewProvider {
    static var previews: some View {
        PickMenu(image: "soft_egg", title: "완전 반숙", needTime: 8, description: "촉촉하고 부드러운 노른자로            삶아집니다.", bgColor: Color.orange)
    }
}
